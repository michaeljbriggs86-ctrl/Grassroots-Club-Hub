...
**Code marker:** `approved-app-ui-2026-09-19-v1.1-responsive-imagery`
...
Use the Grassroots Club Hub shield/logo supplied with the app. Do not redraw it, substitute a generic football badge, distort it, recolour it arbitrarily, or combine it with unrelated club marks.

The primary lock-up is:

**Grassroots Club Hub**  
**PEOPLE · TEAMS · STRONGER TOGETHER**
...
These screens must use real generated football imagery assets. The three hero images may differ, but composition, brand header, fields, buttons and spacing must remain one family.
