...
check('versionCode 2217','versionCode 2217' in gradle)
check('versionName 2.2.17',"versionName '2.2.17'" in gradle)
check('applicationId preserved',"applicationId 'com.grassrootsclubhub.universal'" in gradle)
check('native marker version','GrassrootsClubHub/2.2.17' in main)
...
check('About version 2.2.17','App version 2.2.17' in index)
check('manifest name PitchKind',manifest.get('name')=='PitchKind' and manifest.get('short_name')=='PitchKind')
check('manifest version 2.2.17',manifest.get('version')=='2.2.17')
...
check(
    'v2.2.17 native User-Agent constant',
    'private static final String NATIVE_USER_AGENT' in main
    and 'GrassrootsClubHub/2.2.17' in main
...
check(
    'v2.2.17 workflow and artifact gate',
    'Android APK v2.2.17 PitchKind' in apk_workflow
    and 'verify_v2_2_17_pitchkind_ui.py' in apk_workflow
    and 'App version 2.2.17' in apk_workflow
    and 'PitchKind-v2.2.17-debug.apk' in apk_workflow
    and 'GrassrootsClubHub/2.2.17' in apk_workflow,
)
...
check(
    ...
    and sha('app/src/main/assets/shooters-hill-logo.png')=='2acda473eeba83c7008c389dc34808a28f7435c69139b0af8011f866ac6912af'
