...
check('versionCode 2210','versionCode 2210' in gradle)
check('versionName 2.2.10',"versionName '2.2.10'" in gradle)
check('applicationId preserved',"applicationId 'com.grassrootsclubhub.universal'" in gradle)
check('native marker version','GrassrootsClubHub/2.2.10' in main)
...
check('About version 2.2.10','App version 2.2.10' in index)
check('manifest name PitchKind',manifest.get('name')=='PitchKind' and manifest.get('short_name')=='PitchKind')
check('manifest version 2.2.10',manifest.get('version')=='2.2.10')
