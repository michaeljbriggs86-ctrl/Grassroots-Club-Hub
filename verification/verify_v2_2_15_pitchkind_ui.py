...
check('versionCode 2215','versionCode 2215' in gradle)
check('versionName 2.2.15',"versionName '2.2.15'" in gradle)
check('applicationId preserved',"applicationId 'com.grassrootsclubhub.universal'" in gradle)
check('native marker version','GrassrootsClubHub/2.2.15' in main)
...
check('About version 2.2.15','App version 2.2.15' in index)
check('manifest name PitchKind',manifest.get('name')=='PitchKind' and manifest.get('short_name')=='PitchKind')
check('manifest version 2.2.15',manifest.get('version')=='2.2.15')
...
check(
    'v2.2.15 native User-Agent constant',
    'private static final String NATIVE_USER_AGENT' in main
    and 'GrassrootsClubHub/2.2.15' in main
...
check(
    'v2.2.15 workflow and artifact gate',
    'Android APK v2.2.15 PitchKind' in apk_workflow
    and 'verify_v2_2_15_pitchkind_ui.py' in apk_workflow
    and 'App version 2.2.15' in apk_workflow
    and 'PitchKind-v2.2.15-debug.apk' in apk_workflow
    and 'GrassrootsClubHub/2.2.15' in apk_workflow,
)
