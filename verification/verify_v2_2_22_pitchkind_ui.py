...
backend_contract=txt('LIVE_BACKEND_CONTRACT_v2_2_22.txt')

check('versionCode 2222','versionCode 2222' in gradle)
check('versionName 2.2.22',"versionName '2.2.22'" in gradle)
check('applicationId preserved',"applicationId 'com.grassrootsclubhub.universal'" in gradle)
check('native marker version','GrassrootsClubHub/2.2.22' in main)
...
check('About version 2.2.22','App version 2.2.22' in index)
check('manifest name PitchKind',manifest.get('name')=='PitchKind' and manifest.get('short_name')=='PitchKind')
check('manifest version 2.2.22',manifest.get('version')=='2.2.22')
...
check(
    'v2.2.22 native User-Agent constant',
    'private static final String NATIVE_USER_AGENT' in main
    and 'GrassrootsClubHub/2.2.22' in main
...
check(
    'v2.2.22 workflow and artifact gate',
    'Android APK v2.2.22 PitchKind' in apk_workflow
    and 'verify_v2_2_22_pitchkind_ui.py' in apk_workflow
    and 'App version 2.2.22' in apk_workflow
    and 'PitchKind-v2.2.22-debug.apk' in apk_workflow
    and 'GrassrootsClubHub/2.2.22' in apk_workflow,
)
...
check(
    ...
    and 'Child: ${req.child_name}' in app
    and '${req.parent_email}' in app,
)
check(
