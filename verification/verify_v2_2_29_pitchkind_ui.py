...
check('versionCode 2229','versionCode 2229' in gradle)
check('versionName 2.2.29',"versionName '2.2.29'" in gradle)
check('applicationId preserved',"applicationId 'com.grassrootsclubhub.universal'" in gradle)
check('native marker version','GrassrootsClubHub/2.2.29' in main)
...
check('About version 2.2.29','App version 2.2.29' in index)
check('manifest name PitchKind',manifest.get('name')=='PitchKind' and manifest.get('short_name')=='PitchKind')
check('manifest version 2.2.29',manifest.get('version')=='2.2.29')
...
check(
    'v2.2.29 native User-Agent constant',
    'private static final String NATIVE_USER_AGENT' in main
    and 'GrassrootsClubHub/2.2.29' in main
...
check(
    'v2.2.29 workflow and artifact gate',
    'Android APK v2.2.29 PitchKind' in apk_workflow
    and 'verify_v2_2_29_pitchkind_ui.py' in apk_workflow
    and 'App version 2.2.29' in apk_workflow
    and 'PitchKind-v2.2.29-debug.apk' in apk_workflow
    and 'GrassrootsClubHub/2.2.29' in apk_workflow,
)
...
check('v2.2.29 JS checks native share preparation result',
    'ClubHubNative?.shareMatchCard' in app
    and 'shareMatchCard(dataUrl,caption)' in app
    and 'Could not prepare matchday share image' in app)
