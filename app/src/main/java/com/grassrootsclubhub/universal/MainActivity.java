...
public class MainActivity extends Activity {
    ...
    private static final String NATIVE_USER_AGENT = "Mozilla/5.0 (Linux; Android 14) AppleWebKit/537.36 Chrome/126 Mobile Safari/537.36 GrassrootsClubHub/2.2.34";
    ...
    @Override public void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("file:///android_asset/index.html?build=2234");
