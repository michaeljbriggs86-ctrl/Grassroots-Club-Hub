...
check('versionCode 2227','versionCode 2227' in gradle)
check('versionName 2.2.27',"versionName '2.2.27'" in gradle)
check('applicationId preserved',"applicationId 'com.grassrootsclubhub.universal'" in gradle)
check('native marker version','GrassrootsClubHub/2.2.27' in main)
...
check('About version 2.2.27','App version 2.2.27' in index)
check('manifest name PitchKind',manifest.get('name')=='PitchKind' and manifest.get('short_name')=='PitchKind')
check('manifest version 2.2.27',manifest.get('version')=='2.2.27')
...
check(
    'v2.2.27 native User-Agent constant',
    'private static final String NATIVE_USER_AGENT' in main
    and 'GrassrootsClubHub/2.2.27' in main
...
check(
    'v2.2.27 workflow and artifact gate',
    'Android APK v2.2.27 PitchKind' in apk_workflow
    and 'verify_v2_2_27_pitchkind_ui.py' in apk_workflow
    and 'App version 2.2.27' in apk_workflow
    and 'PitchKind-v2.2.27-debug.apk' in apk_workflow
    and 'GrassrootsClubHub/2.2.27' in apk_workflow,
)
